...
3. 关键时间线：目标、调查、拆分、委派、问题、回传、纠偏、整合、验收。
4. Issue 树评审：覆盖、重叠、角色、粒度和关键路径。
5. 信息流审计：关键事实从产生到消费的完整链。
6. 效率分解：work、coordination、validation、idle、retry 和人工成本。
7. 首次失效点、根因、促成因素、严重度和责任模块。
8. 优化建议：短期规则/Prompt、中期契约/工具、长期架构改动。
