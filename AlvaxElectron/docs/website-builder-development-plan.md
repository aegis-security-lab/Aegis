...
在现有 Alvax Studio Electron 安全边界之上，开发一个对话驱动的网站生成工作台。用户提供行业、产品或服务、目标用户和网站用途，Pi Agent 完成需求澄清、信息架构、页面文案、基础视觉、代码生成、构建修复和本地预览交付。
...
```text
┌───────────────────────────────────────────────────────────────────────┐
│ Alvax Studio / 项目标题                Runtime · Model · More         │
├────────────────────────────────────────────┬──────────────────────────┤
│                                            │ Delivery                 │
